            ...
            <Table aria-label="customized table">
                ...
                <TableBody>
                    ...
                    <TableRow key={index}>
                        ...
                        <StyledTableCell align="center">{report.awakeTime}</StyledTableCell>
                        <StyledTableCell align="center"><Button onClick={() => {setOpen(true); setModalData(report.courseStudies)}}>نمایش</Button></StyledTableCell>
                    </TableRow>
                    ))}
                </TableBody>
            </Table>
